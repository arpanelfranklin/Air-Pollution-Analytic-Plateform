...
[Overview](#-overview) • [Architecture](#-system-architecture) • [Tech Stack](#-technology-stack) • [CI/CD](#-cicd-pipeline) • [Screenshots](#-screenshots) • [API](#-rest-api-reference) • [Getting Started](#-getting-started)
...
flowchart TD
    ...
    Push --> GitOpsRepo["📝 Update K8s Manifests in Git"]
...
3. Once the image passes all checks, Jenkins pushes it to the image registry and updates the Kubernetes manifests in the GitOps repository.
...
6. The REST API layer serves the processed pollution data to any consumer — dashboards, scripts, or other services.
